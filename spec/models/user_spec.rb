...
RSpec.describe User, type: :model do
  ...
  it "accepts properly formatted eamil" do
    emails = ["drake@ovo.com", "drake.greatest@ovo.com"]
  ...
  it "requires a unique, case insensitive email address" do
    user1 = User.create(name: "drake", email: "drake@ovo.com", password: "password", password_confirmation: "password")
  ...
  it "automatically encrypts the password into the password_digest attribute" do
    user = User.create(name:"drake", email: "drake@ovo.com", password: "password", password_confirmation: "password")
